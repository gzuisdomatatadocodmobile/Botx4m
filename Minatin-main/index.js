	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Tchau @${num.split('@')[0]} Que pena gostava tando dele(a)🥺`
				let buff = await getBuffer(ppimg)
				client.sendMessage(mdata.id, buff, MessageType.image, {caption: teks, contextInfo: {"mentionedJid": [num]}})
			}
		} catch (e) {
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD X4M BOT*',
					...
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de X4M. Registre-se para fazer amizade com o bot X4M por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar Minatin|17\n\n──「 X4M BOT 」──`,
			...
			const ownerNumber = ["5532999086991@s.whatsapp.net","12267740582@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5532999086991@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5532999086991@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5532999086991@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5532999086991@s.whatsapp.net","557399469117@s.whatsapp.net","12267740582@s.whatsapp.net","559784130980@s.whatsapp.net","557599941062@s.whatsapp.net","558598669655@s.whatsapp.net","5511949051934@s.whatsapp.net","554792091566@s.whatsapp.net","558699541889@s.whatsapp.net","559294313229@s.whatsapp.net","554298653614@s.whatsapp.net","12267740582@s.whatsapp.net"]
...
if (text.includes("placa"))
  ...
  conn.sendMessage(id, hasil, MessageType.text); 
		...
		setTimeout( () => {
			client.updatePresence(from, Presence.composing)
			reply("5 segundo KKKKKKKK tchau amigo 😔🤙")
		}, 0)
	}
